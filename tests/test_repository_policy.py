...
REQUIRED_FILES = {
    ".github/workflows/native-arm64-runtime.yml",
    "CONTRIBUTING.md",
    "DATA_LICENSES.md",
    "DEVELOPING.md",
    "LICENSE",
    ...
    "baselines/requirements-hybrid-train.txt",
    "baselines/requirements-train.txt",
    "baselines/train_bert_hybrid.py",
    "baselines/train_char_tfidf.py",
    "baselines/train_hash_regex.py",
    "baselines/train_word_tfidf.py",
    "baselines/validate_bert_router.py",
    "baselines/validate_content_logo.py",
    ...
    "src/ossp_router/bert_residual.py",
    "src/ossp_router/bert_router.py",
    "src/ossp_router/char_tfidf.py",
    "src/ossp_router/cli.py",
    "src/ossp_router/hash_linear.py",
    ...
    "src/ossp_router/public_cost_lookup.py",
    "src/ossp_router/public_runtime.py",
    "src/ossp_router/resources/char-tfidf-ridge.v1.json",
    ...
    "src/ossp_router/resources/tiny-bert-residual.v1.json",
    "src/ossp_router/resources/word-tfidf-ridge.v1.json",
    "src/ossp_router/runtime.py",
    "src/ossp_router/scoring.py",
    "src/ossp_router/source_manifest.py",
    "src/ossp_router/tiebreak_latency.py",
    "src/ossp_router/tiny_bert.py",
    "src/ossp_router/word_tfidf.py",
    "tests/test_bert_residual.py",
    "tests/test_bert_router.py",
    "tests/test_char_tfidf.py",
    ...
    "tests/test_hash_linear.py",
    "tests/test_prompt_heuristic.py",
    "tests/test_public_cost_lookup.py",
    "tests/test_public_runtime.py",
    "tests/test_retry_policy.py",
    "tests/test_runtime.py",
    "tests/test_tiebreak_latency.py",
    "tests/test_tiny_bert.py",
    "tests/test_validate_content_logo.py",
    "tests/test_word_tfidf.py",
...
class RepositoryPolicyTest(unittest.TestCase):
    ...
    def test_native_arm64_runtime_workflow_is_manual_and_fail_closed(self) -> None:
        workflow = (ROOT / ".github/workflows/native-arm64-runtime.yml").read_text(
            encoding="utf-8"
        )
        ...
        for marker in (
            ...
            "PYTHONPATH=src python tools/check_runtime.py",
            "--repetitions 3",
            '"memory_bytes": 2_147_483_648',
            '"processes_and_threads_total": 32',
            'len(tier["repetitions"]) == 3',
            "assert len(hashes) == 1",
            "image_size <= 1_073_741_824",
            'report["runtime"]["docker_server_platform"] == "linux/arm64"',
            'tier["elapsed_seconds_max"] <= 90',
            "actions/upload-artifact@v4",
            "native-arm64-runtime-${{ github.sha }}",
        ):
